...
$aRsURL = urlencode("http://connect.saja.com.tw/firstbank/receiver.php");	//測試結果返回網址,上線後為固定值

$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://connect.saja.com.tw/firstbank/connect_encode.php");
